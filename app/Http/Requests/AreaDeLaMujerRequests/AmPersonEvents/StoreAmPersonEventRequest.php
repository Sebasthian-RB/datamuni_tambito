...
/**
 * Request para validar la creación de un AmPersonEvent.
 */
class StoreAmPersonEventRequest extends FormRequest
{
    /**
    ...
    /**
     * Reglas de validación para almacenar un nuevo registro de AmPersonEvent.
     *
