...
/**
 * Form Request para crear un instrumento.
 * Aquí se definen las reglas de validación para la creación de los instrumentos.
 */
    ...
    public function rules(): array
    {
        return [
            ...
            'description' => [
                'nullable',
                'string',
                'max:1000', // Limitar la longitud máxima de la descripción
            ],
        ];
    }
