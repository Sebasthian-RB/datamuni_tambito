...
@section('content_header')
    <div class="diagnostic-banner">
        ...
        <div class="banner-content">
            ...
            <p class="lead">Información completa del diagnóstico psicológico</p>
        </div>
    </div>
@endsection
        ...
        <div class="card shadow-lg border-0">
            <div class="card-header gradient-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="mb-0"><i class="fas fa-file-medical"></i> Detalles del Registro</h3>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="detail-item-patient mb-5">
                            <div class="avatar-lg bg-soft-primary rounded-circle me-5">
                                <span
                                    class="avatar-initial-lg">{{ substr($psychologicalDiagnosis->person->full_name, 0, 1) }}</span>
                            </div>
                            <div class="patient-info">
                                <h3 class="text-primary mb-2">{{ $psychologicalDiagnosis->person->full_name }}</h3>
                        ...
                        <div class="detail-card diagnosis-box mt-5">
                            <div class="detail-header">
                                <i class="fas fa-stethoscope me-2"></i> Evaluación Psicológica
                            </div>
                            <div class="detail-content">
                                {{ $psychologicalDiagnosis->diagnosis ?? 'No registrado' }}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="info-card">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    <span class="info-label">Fecha del diagnóstico</span>
                                    <span class="info-value fs-5">
                                        {{ \Carbon\Carbon::parse($psychologicalDiagnosis->diagnosis_date)->isoFormat('DD MMM YYYY') }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    <span class="info-label">Sesiones recomendadas</span>
                                    <span class="info-value fs-5 badge bg-soft-primary text-primary">
                                        {{ $psychologicalDiagnosis->recommended_sessions }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <span class="info-value fs-5">
                                        {{ $psychologicalDiagnosis->updated_at->diffForHumans() }}
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            {{-- Footer --}}
            <div class="card-footer gradient-header">
                <a href="{{ route('psychological-diagnoses.index') }}" class="btn btn-outline-light btn-elevate btn-lg">
