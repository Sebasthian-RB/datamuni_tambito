...
@section('content_header')
    ...
    <div class="d-flex justify-content-center align-items-center py-3"
        style="background: #f00e1c; border-radius: 0 0 15px 15px;">
        <img src="{{ asset('Images/Logomunicipalidad_tambo.png') }}" alt="Logo Cuidador" class="img-fluid"
...
@section('content')
    <div class="card shadow-lg"
        ...
        <div class="card-footer text-center" style="background: #f00e1c; border-radius: 0 0 15px 15px;">
            ...
            <a href="{{ route('caregivers.edit', $caregiver) }}" class="btn btn-lg btn-light shadow-sm"
