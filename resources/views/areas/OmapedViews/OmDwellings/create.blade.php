            ...
            <form action="{{ route('om-dwellings.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="annex_sector" id="annex_sector"
                        class="form-control @error('annex_sector') is-invalid @enderror" value="{{ old('annex_sector') }}">
                    @error('annex_sector')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="water_electricity" id="water_electricity"
                        ...
                        <option value="Agua y Luz" {{ old('water_electricity') == 'Agua y Luz' ? 'selected' : '' }}>Agua y
                            Luz</option>
                        <option value="Ninguno" {{ old('water_electricity') == 'Ninguno' ? 'selected' : '' }}>Ninguno
                        </option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="ownership_status" id="ownership_status"
                        ...
                        <option value="Alquilada" {{ old('ownership_status') == 'Alquilada' ? 'selected' : '' }}>Alquilada
                        </option>
                        <option value="Prestada" {{ old('ownership_status') == 'Prestada' ? 'selected' : '' }}>Prestada
                        </option>
                    </select>
