        ...
        <div class="card-body" style="background: linear-gradient(135deg, #f8b19550 0%, #f6728050 100%);">
            <form action="{{ route('am_person_violences.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            <label for="violence_id" class="font-weight-bold" style="color: #355c7d;">Tipo de
                                Violencia</label>
                            <select name="violence_id" id="violence_id" class="form-control select2 shadow-sm"
                                style="border: 2px solid #c06c84; border-radius: 8px;" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-4">
                            ...
                            <input type="datetime-local" name="registration_date" id="registration_date"
                                class="form-control shadow-sm" style="border: 2px solid #c06c84; border-radius: 8px;"
                                required>
                        </div>
                    </div>
                </div>
