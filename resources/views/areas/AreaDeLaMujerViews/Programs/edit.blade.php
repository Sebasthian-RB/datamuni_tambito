    ...
    <div class="card-body" style="background: linear-gradient(135deg, #f8b19550 0%, #f6728050 100%);">
        <form action="{{ route('programs.update', $program) }}" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="program_type" id="program_type" class="form-control" value="{{ old('program_type', $program->program_type) }}" required>
            </div>

            <div class="form-group mb-4">
                <label for="start_date" class="font-weight-bold" style="color: #355c7d;">Fecha de Inicio</label>
                <input type="datetime-local" name="start_date" id="start_date" class="form-control" value="{{ old('start_date', $program->start_date) }}" required>
            </div>

            <div class="form-group mb-4">
                <label for="end_date" class="font-weight-bold" style="color: #355c7d;">Fecha de Fin</label>
                <input type="datetime-local" name="end_date" id="end_date" class="form-control" value="{{ old('end_date', $program->end_date) }}">
            </div>
            ...
            <div class="text-right mt-4">
                ...
                <a href="{{ route('programs.index') }}" class="btn btn-lg btn-secondary shadow-sm" style="border-radius: 8px;">
