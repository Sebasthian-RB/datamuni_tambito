        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="header-content">
                    <div>
                        <h1 class="card-title">Editar Miembro de Familia</h1>
                        <p class="card-subtitle">Complete los campos para actualizar el familiar.</p>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control @error('id') is-invalid @enderror" id="id" name="id" value="{{ old('id', $vlFamilyMember->id) }}" placeholder="Ej: 12345678" required>
                                    @error('id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-control @error('identity_document') is-invalid @enderror" id="identity_document" name="identity_document" required>
                                        <option value="" disabled class="placeholder-option">Seleccione Tipo de Documento</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control @error('paternal_last_name') is-invalid @enderror" id="paternal_last_name" name="paternal_last_name" value="{{ old('paternal_last_name', $vlFamilyMember->paternal_last_name) }}" placeholder="Ej: Pérez" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control @error('maternal_last_name') is-invalid @enderror" id="maternal_last_name" name="maternal_last_name" value="{{ old('maternal_last_name', $vlFamilyMember->maternal_last_name) }}" placeholder="Ej: Gómez">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-4">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control @error('given_name') is-invalid @enderror" id="given_name" name="given_name" value="{{ old('given_name', $vlFamilyMember->given_name) }}" placeholder="Ej: Juan Carlos" required>
                                    @error('given_name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
            ...
            <div class="card-footer text-right">
                <button type="submit" class="btn btn-custom">Actualizar Miembro</button>
