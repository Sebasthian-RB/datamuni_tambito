...
@section('title', 'Asignar Producto a Familiar')
...
@section('content')
<div class="container">
    <form action="{{ route('vl_family_member_products.store') }}" method="POST">
        @csrf
        <div class="card">
            <!-- Card Header -->
            <div class="card-header">
                <div class="header-content">
                    <div>
                        <h1 class="card-title">Asignar Producto a Familiar</h1>
                        <p class="card-subtitle">Complete los campos para asignar un producto a un familiar.</p>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity') }}" placeholder="Ej: 2" min="1" required>
                                    @error('quantity')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
