...
@section('css')
    ...
    <style>
        ...
        .table tbody td:nth-child(3) {
            width: 40%; /* Ajustar ancho de la columna Responsable */
        }
    ...
    <div class="card-header mb-4">
        <div class="header-content">
            <div class="header-text">
                <h1 class="card-title">Lista de Sectores</h1>
                <p class="card-subtitle">Gestión de sectores registrados en el sistema.</p>
            </div>
            ...
            <div class="d-flex justify-content-center mt-4">
                @if ($sectors->hasPages())
                    <ul class="pagination">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $sectors->previousPageUrl() }}" rel="prev">Anterior</a>
                            </li>
                        @endif
                        ...
                        @if ($sectors->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $sectors->nextPageUrl() }}" rel="next">Siguiente</a>
                            </li>
                        @else
                            <li class="page-item disabled">
