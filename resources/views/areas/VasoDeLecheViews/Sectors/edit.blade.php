        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="header-content">
                    <div>
                        <h1 class="card-title">Formulario para editar Sector</h1>
                        <p class="card-subtitle">Complete los campos para actualizar el sector.</p>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $sector->name) }}" placeholder="Ej: Sector I" required>
                                    @error('name')
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control @error('responsible_person') is-invalid @enderror" id="responsible_person" name="responsible_person" value="{{ old('responsible_person', $sector->responsible_person) }}" placeholder="Ej: Apellidos y Nombres" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" placeholder="Ej: Descripción del sector">{{ old('description', $sector->description) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
            ...
            <div class="card-footer text-right">
                <button type="submit" class="btn btn-custom">Actualizar Sector</button>
