                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-control @error('condition') is-invalid @enderror" id="condition" name="condition" required>
                                                ...
                                                @foreach($conditions as $condition)
                                                    <option value="{{ $condition }}" {{ old('condition', $vlMinor->condition) == $condition ? 'selected' : '' }}>
                                                        {{ $condition }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">            
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-control @error('dwelling_type') is-invalid @enderror" id="dwelling_type" name="dwelling_type">
                                                <option value="" disabled {{ old('dwelling_type', $vlMinor->dwelling_type) == '' ? 'selected' : '' }}>Seleccione el tipo de vivienda</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-control @error('has_sisfoh') is-invalid @enderror" id="has_sisfoh" name="has_sisfoh" required>
                                                <option value="" disabled>Seleccione el estado SISFOH</option>
                                                <option value="1" {{ (old('has_sisfoh', $vlMinor->has_sisfoh) == '1') ? 'selected' : '' }}>Sí</option>
                                                <option value="0" {{ (old('has_sisfoh', $vlMinor->has_sisfoh) == '0') ? 'selected' : '' }}>No</option>
                                            </select>
                                            @error('has_sisfoh')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-6">                                        
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-control @error('sisfoh_classification') is-invalid @enderror" id="sisfoh_classification" name="sisfoh_classification">
                                                <option value="" disabled>Seleccione la clasificación SISFOH</option>
                                                @foreach($sisfohClassifications as $classification)
                                                    <option value="{{ $classification }}" {{ (old('sisfoh_classification', $vlMinor->sisfoh_classification) == $classification) ? 'selected' : '' }}>{{ $classification }}</option>
                                                @endforeach
                                            </select>                                    
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-control @error('education_level') is-invalid @enderror" id="education_level" name="education_level">
                                        ...
                                        @foreach($educationLevels as $level)
                                            <option value="{{ $level }}" {{ old('education_level', $vlMinor->education_level) == $level ? 'selected' : '' }}>
                                                {{ $level }}
                                            </option>
                                        @endforeach
                                    </select>                                   
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group mb-4">
                                            ...
                                            <span class="text-danger">*</span>
                                            <select class="form-control select2 @error('vl_family_member_id') is-invalid @enderror" 
                                                id="vl_family_member_id" 
                                                name="vl_family_member_id" 
                                                required>
                                                <option value="" disabled>Seleccione un miembro de familia</option>
                                                @foreach($vlFamilyMembers as $member)
                                                    <option value="{{ $member->id }}"
                                                        ...
                                                        {{ $vlMinor->vl_family_member_id == $member->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <select name="kinship" id="kinship" class="form-control @error('kinship') is-invalid @enderror" required>
                                                ...
                                                @foreach($kinships as $kinship)
                                                    <option value="{{ $kinship }}" {{ old('kinship', $vlMinor->kinship) == $kinship ? 'selected' : '' }}>{{ $kinship }}</option>
                                                @endforeach
                                            </select>                                            
                                            @error('kinship')
                                                <span class="invalid-feedback">{{ $message }}</span>
