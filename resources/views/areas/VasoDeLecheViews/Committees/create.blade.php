                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control @error('committee_number') is-invalid @enderror" id="committee_number" name="committee_number" value="{{ old('committee_number') }}" placeholder="Ej: 1234" required>
