...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p><span class="detail-label">Sector:</span> <span class="detail-value">{{ $committee->sector->name }}</span></p>
        </div>

        <!-- Card Footer -->
        <div class="card-footer text-right">
            <a href="{{ route('committees.edit', $committee->id) }}" class="btn btn-custom">Editar</a>
