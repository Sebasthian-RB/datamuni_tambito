...
@section('title', 'Listado de Instrumentos')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: #228B22; color:white;">
                    <h3 class="card-title">Lista de Instrumentos</h3>
                    <div class="card-tools">
                        <a href="{{ route('instruments.create') }}" class="btn btn-primary btn-sm btn-with-border btn-primary-custom">
                ...
                <div class="card-body card-body-con-fondo">
                    ...
                    @endif
                    <table id="instruments-table" class="table table-bordered table-hover" style="width:100%">
                            ...
                            @foreach($instruments as $instrument)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('instruments.edit', $instrument) }}" class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i> Editar
                                        </a>
                                        <form action="{{ route('instruments.destroy', $instrument) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de eliminar este instrumento?')">
