...
use App\Http\Controllers\SisfohControllers\SisfohDashboardController; //dashboard de Sisfoh
...
Route::middleware([
    ...
    // Route::get('/sisfoh', [SisfohController::class, 'index'])->name('sisfoh.index');
